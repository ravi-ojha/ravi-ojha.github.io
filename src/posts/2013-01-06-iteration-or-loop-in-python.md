...
![Iteration or Looping in Python](/posts/iteration-in-python.jpg)
...
Next we will apply the knowledge gained so far to solve an interesting problem. [How to find square root of any number?](/posts/finding-square-root-using-guess-and-check-algorithm-in-python)
