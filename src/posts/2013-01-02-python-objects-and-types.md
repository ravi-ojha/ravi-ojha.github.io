...
There are many more types in Python, we will see them one at a time in future posts. Some important ones are: [List](/posts/python-lists-and-list-methods), [Dictionary](/posts/python-dictionary-and-its-properties), [Tuple](/posts/python-tuples-and-basic-operations-on-tuples).
