...
In Python, you will notice so many similarities between the methods on [strings](/posts/python-strings-and-frequently-used-str-methods), [tuples](/posts/python-tuples-and-basic-operations-on-tuples) and [lists](/posts/python-lists-and-list-methods). It is so easy to understand them one you understand one of them. Next, we will see [Lists in Python](/posts/python-lists-and-list-methods).
