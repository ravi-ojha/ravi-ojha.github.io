...
There's another technique which optimizes a recursive code, it's called [Memoization, also known as Dynamic Programming](/posts/what-is-memoization-what-is-dynamic-programming).
