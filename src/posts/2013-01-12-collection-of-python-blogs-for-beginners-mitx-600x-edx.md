...
## List of python blogs for beginners in Python
 ...
 - [Syntax, Static Semantics, Semantics of a Language](/posts/python-syntax-static-semantics-semantics-of-a-language)
 ...
 - [Python Objects and Types](/posts/python-objects-and-types)
 ...
 - [Arithmetic and Logical Operators in Python](/posts/arithmetic-and-logical-operators-in-python)
 ...
 - [Python Strings and it's frequently used methods](/posts/python-strings-and-frequently-used-str-methods)
 ...
 - [Control Flow: Branching code flow using if - else - elif](/posts/branching-with-if-else-elif-in-python)
   - If this Then that! Python provides us with if, else and elif to add conditions in code and branch it like a tree

 - [Loops: Perform repetitive tasks through Iteration](/posts/iteration-or-loop-in-python) using `while` and `for` constructs
 ...
 - [Guess & Check Algorithm: Finding Square Root using Guess and Check](/posts/finding-square-root-using-guess-and-check-algorithm-in-python)
 ...
 - [Bisection Search: Linear Search v/s Bisection (Binary) Search](/posts/linear-search-vs-bisection-search-in-python)
 ...
 - [Basics of Recursion with an example in Python](/posts/basics-of-recursion-in-programming-using-a-simple-example)
 ...
 - [Python: Lists and List methods](/posts/python-lists-and-list-methods)
   - Declaring, Accessing, Slicing, Deleting and Updating Lists and its elements in Python

 - [Python: Tuples and Basic Operations on Tuples](/posts/python-tuples-and-basic-operations-on-tuples)
   - What is a tuple? How is it different from a list? And some basic methods on Tuples

 - [Python: Dictionary and its properties](/posts/python-dictionary-and-its-properties)
 ...
 - [How to compute Time Complexity or Order of Growth of any program?](/posts/how-to-compute-time-complexity-order-of-growth-of-any-program)
 ...
 - [What is Memoization? What is Dynamic Programming?](/posts/what-is-memoization-what-is-dynamic-programming)
