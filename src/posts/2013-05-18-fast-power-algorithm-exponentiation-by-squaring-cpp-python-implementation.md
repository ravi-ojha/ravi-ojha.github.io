...
See how we can use Fast Power Algorithm to [find Modular Multiplicative Inverse of a number](/posts/how-to-find-multiplicative-inverse-of-a-number-modulo-m-in-python-cpp).
