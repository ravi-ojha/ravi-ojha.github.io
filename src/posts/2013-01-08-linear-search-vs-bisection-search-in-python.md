...
We make use of the concept of Binary Search to [find square root of a number in an efficient way](/posts/finding-square-root-using-guess-and-check-algorithm-in-python).
